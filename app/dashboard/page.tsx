...
export default function Dashboard() {
  ...
  const recentProjects: Array<{id: string; name: string; description: string; status: "active" | "planning" | "completed"; lastActivity: string; agents: string[]; progress: number}> = [
    {
      id: "1",
  ...
  const agents: Array<{name: string; role: string; status: "active" | "idle" | "busy"; lastMessage: string; color: string}> = [
    {
      name: "EMEFA",
      role: "Team Lead AI",
      status: "active",
